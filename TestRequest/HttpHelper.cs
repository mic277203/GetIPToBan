...
namespace TestRequest
{
    public class HttpHelper
    {
        ...
        /// <returns></returns>  
        public HttpWebResponse CreateGetHttpResponse(string url, NetworkCredential credential = null, int? timeout = 300, string userAgent = "", CookieCollection cookies = null
        ...
        /// <param name="cookies">随同HTTP请求发送的Cookie信息，如果不需要身份验证可以为空</param>  
        /// <returns></returns>  
        public HttpWebResponse CreatePostHttpResponse(string url, IDictionary<string, string> parameters, Encoding requestEncoding, int? timeout = 300, string userAgent = "", CookieCollection cookies = null, string Referer = "", Dictionary<string, string> headers = null, string contentType = "application/x-www-form-urlencoded")
        {
            if (Debug)
            {
        ...
        /// <param name="cookies">随同HTTP请求发送的Cookie信息，如果不需要身份验证可以为空</param>  
        /// <returns></returns>  
        public HttpWebResponse CreatePostHttpResponse(string url, string parameters, Encoding requestEncoding, NetworkCredential credential = null, int? timeout = 300, string userAgent = "", CookieCollection cookies = null, string Referer = "", Dictionary<string, string> headers = null, string contentType = "application/x-www-form-urlencoded")
        {
            if (Debug)
            {
        ...
        public string Post(string url, string parameters, Encoding requestEncoding, Encoding responseEncoding, NetworkCredential credential = null, int? timeout = 300, string userAgent = "", CookieCollection cookies = null, string Referer = "", Dictionary<string, string> headers = null, string contentType = "application/x-www-form-urlencoded")
        {
            HttpWebResponse response = CreatePostHttpResponse(url, parameters, requestEncoding, credential, timeout, userAgent, cookies, Referer, headers, contentType);
        ...
        public T Post<T>(string url, string parameters, Encoding requestEncoding, Encoding responseEncoding, NetworkCredential creadential = null, int? timeout = 300, string userAgent = "", CookieCollection cookies = null, string Referer = "", Dictionary<string, string> headers = null, string contentType = "application/x-www-form-urlencoded")
        {
            return JsonConvert.DeserializeObject<T>(Post(url, parameters, requestEncoding, responseEncoding, creadential, timeout, userAgent, cookies, Referer, headers, contentType));
        }
        ...
        public string Get(string url, Encoding responseEncoding, NetworkCredential credential = null, int? timeout = 300, string userAgent = "", CookieCollection cookies = null
            , string Referer = "", Dictionary<string, string> headers = null, string contentType = "application/x-www-form-urlencoded")
        {
            HttpWebResponse response = CreateGetHttpResponse(url, credential, timeout, userAgent, cookies, Referer, headers, contentType);
        ...
        public T Get<T>(string url, Encoding responseEncoding, NetworkCredential credential = null, int? timeout = 300, string userAgent = "",
            CookieCollection cookies = null, string Referer = "", Dictionary<string, string> headers = null,
            string contentType = "application/x-www-form-urlencoded")
        {
            return JsonConvert.DeserializeObject<T>(Get(url, responseEncoding, credential, timeout, userAgent, cookies, Referer, headers, contentType));
        }

        public byte[] GetFile(string url, out Dictionary<string, string> header, NetworkCredential credential, int? timeout = 300, string userAgent = "", CookieCollection cookies = null, string Referer = "", Dictionary<string, string> headers = null)
        {
            HttpWebResponse response = CreateGetHttpResponse(url, credential, timeout, userAgent, cookies, Referer, headers);
        ...
        public Stream GetStream(string url, NetworkCredential credential = null, int? timeout = 300, string userAgent = "", CookieCollection cookies = null, string Referer = "", Dictionary<string, string> headers = null)
        {
            HttpWebResponse response = CreateGetHttpResponse(url, credential, timeout, userAgent, cookies, Referer, headers);
